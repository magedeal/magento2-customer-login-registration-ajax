...
namespace Magedeal\CustomerAccount\Block\Form;
...
class Register extends \Magento\Directory\Block\Data
{
    ...
    {
        return $this->getUrl('magedeal/customer_ajax/register');
    }
    ...
    /**
     * Checking checkout URL
     *
     * @return string
     */
    public function getContinueAsGuestUrl()
    {
        return $this->_urlBuilder->getUrl('checkout.html');
    }
}
